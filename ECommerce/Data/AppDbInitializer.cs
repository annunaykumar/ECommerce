            ...
            using (var applicationservies = builder.ApplicationServices.CreateScope())
            {
                ...
                if (!context.Products.Any())
                {
                    var Products = new List<Product>()
                    {
                        new Product()
                        {
                            Name = "P1",Description="D1",Price=150,ImageURL="https://cdn.pixabay.com/photo/2015/12/20/01/03/engine-1100588__340.jpg",
                            ProductColor = ProductColor.Red,CategoryId=1
                        },
                        new Product()
                        {
                            Name = "P2",Description="D2",Price=200,ImageURL="https://cdn.pixabay.com/photo/2015/02/03/02/04/car-621822__340.jpg",
                            ProductColor = ProductColor.Green,CategoryId=2
                        },
                        new Product()
                        {
                            Name = "P3",Description="D3",Price=300,ImageURL="https://cdn.pixabay.com/photo/2021/02/05/21/10/starter-5985938__340.jpg",
                            ProductColor = ProductColor.Yellow,CategoryId=3
                        },
                        new Product()
                        {
                            Name = "P4",Description="D4",Price=400,ImageURL="https://thumbs.dreamstime.com/z/old-auto-spare-parts-car-white-background-old-auto-spare-parts-car-white-background-set-many-isolated-98969900.jpg",
